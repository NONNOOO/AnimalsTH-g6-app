        ...
        <div className="bg-gradient-to-br from-green-700 to-sky-700" >
            ...
            <div className="sm:p-16 lg:p-50  z-10 ">
                <div className="2xl:max-w-[1280px] w-full mx-auto flex lg:flex-row flex-col gap-8">
                    ...
                    <div className="flex-1 flex justify-center items-center">
                        <img src="https://images.pexels.com/photos/1499596/pexels-photo-1499596.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                            alt=""
                            className="w-[280px] md:h-6/12  object-cover rounded  shadow-sm shadow-green-400" />
                    </div>
                </div>
            </div>
            ...
            <div className="sm:p-16 xs:p-8 px-6 py-12  z-10 ">
                <div className="2xl:max-w-[1280px] w-full mx-auto flex lg:flex-row flex-col gap-8">
                    ...
                    <div className="flex-1 flex justify-center items-center lg:pt-10">
                        <img src="https://media.istockphoto.com/id/471362969/th/%E0%B8%A3%E0%B8%B9%E0%B8%9B%E0%B8%96%E0%B9%88%E0%B8%B2%E0%B8%A2/%E0%B8%9E%E0%B8%B0%E0%B8%A2%E0%B8%B9%E0%B8%99.jpg?b=1&s=612x612&w=0&k=20&c=3q8HTktnKrfWU8rlq0cnoOoB2Old13L0-BMwzrv7pH0="
                            alt=""
            ...
            <div className="sm:p-16 lg:p-50  z-10  ">
                <div className="2xl:max-w-[1280px] w-full mx-auto flex lg:flex-row flex-col gap-8">
                    ...
                    <div className="flex-1 flex justify-center items-center">
                        <img src="https://images.pexels.com/photos/15544997/pexels-photo-15544997.jpeg?auto=compress&cs=tinysrgb&w=600"
                            alt=""
                            className="md:h-6/12  object-cover rounded  shadow-sm shadow-green-400" />
                    </div>
                </div>
            </div>
